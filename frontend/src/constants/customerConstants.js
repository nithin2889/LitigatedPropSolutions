...
export const CUSTOMER_CREATE_PROPERTY_REQUEST =
  "CUSTOMER_CREATE_PROPERTY_REQUEST";
export const CUSTOMER_CREATE_PROPERTY_SUCCESS =
  "CUSTOMER_CREATE_PROPERTY_SUCCESS";
export const CUSTOMER_CREATE_PROPERTY_FAIL = "CUSTOMER_CREATE_PROPERTY_FAIL";
export const CUSTOMER_CREATE_PROPERTY_RESET = "CUSTOMER_CREATE_PROPERTY_RESET";

export const CUSTOMER_UPDATE_PROPERTY_REQUEST =
  "CUSTOMER_UPDATE_PROPERTY_REQUEST";
export const CUSTOMER_UPDATE_PROPERTY_SUCCESS =
  "CUSTOMER_UPDATE_PROPERTY_SUCCESS";
export const CUSTOMER_UPDATE_PROPERTY_FAIL = "CUSTOMER_UPDATE_PROPERTY_FAIL";
export const CUSTOMER_UPDATE_PROPERTY_RESET = "CUSTOMER_UPDATE_PROPERTY_RESET";

export const CUSTOMER_SAVE_PAYMENT_METHOD = "CUSTOMER_SAVE_PAYMENT_METHOD";
